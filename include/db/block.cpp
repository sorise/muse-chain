...
namespace muse::chain{
    [[maybe_unused]] uint256 block_header::get_block_hash() {
    ...
    block_header::block_header():prev_block_hash(0),data_block_hash(0),transactions_merkle_root(0), affairs_merkle_root(0),height(0),create_time(0) {
